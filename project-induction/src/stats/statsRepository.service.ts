...
export class StatsRepository {
  constructor(
    @InjectModel(StatsSchema.name) private readonly statsModel: Model<StatsSchema>,
  ) { }
  ...
  async update(id: string, updateStatsDto: UpdateStatsDto): Promise<StatsInterface | null> {
